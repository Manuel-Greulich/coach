                        ...
                        <div class="time-column" v-for="day in days" :key="day">
                            ...
                            <div class="time-slots">
                                ...
                                >
                                    ...
                                    >
                                    <div class="resize-handle" @mousedown.stop="startResize(appointment, $event)"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    data() {
        return {
            days: Array.from({ length: 1 }, (_, i) => new Date(2024, 0, 29, 0, 0, 0)), // Ersetzen Sie das Datum entsprechend
            times: Array.from({ length: 96 }, (_, i) => ({ hour: Math.floor(i / 4), minute: (i % 4) * 15 })),
            hours: Array.from({ length: 24 }, (_, i) => i),
            appointments: [
                { id: 1, start: new Date(2024, 0, 29, 10, 15), end: new Date(2024, 0, 1, 11, 45), title: "Team Meeting", color: "#0000ff" },
    ...
    methods: {
        ...
        handleDragStart(appointment, event) {
            if (this.resizingAppointment == null) {
        ...
        startResize(appointment, event) {
            ...
            window.addEventListener("mousemove", this.resizeAppointment(appointment, resizeStart));
            window.addEventListener("mouseup", this.stopResize);
        },
        resizeAppointment(appointment, resizeStart) {
        ...
        stopResize() {
            window.removeEventListener("mousemove", this.resizeAppointment);
